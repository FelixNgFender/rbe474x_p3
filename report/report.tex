...
\subsection{Results}
% Below are some general results for 70 disparities:
% \begin{figure}[!h]
%   \centering
%   \includegraphics[scale=0.25]{./images/results/result1.png}
%   \caption{Image 1, before and after adding patch}
% \end{figure}  
% \begin{figure}[!h]
%     \centering
%     \includegraphics[scale=0.25]{./images/results/result2.png}
%     \caption{Image 2, before and after adding patch}
%   \end{figure} 
